...
IF NOT EXISTS (SELECT 1 FROM [dbo].[TB_M_MENU] WHERE MENU_ID = 'M00008-03')
BEGIN
	INSERT INTO [dbo].[TB_M_MENU] (MENU_ID, PARENT_ID, MENU_NAME, MENU_ICON, MENU_URL, MENU_SEQ, CREATED_BY, CREATED_DT)
	VALUES ('M00008-03', 'M00008', 'Document Receipt Report', 'fa-handshake-o', '/DocumentReceiptReport/Index', 3, 'dms.admin', GETDATE());
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[TB_M_AUTH_MENU] WHERE ROLE_ID = 'DMS-ADMIN' AND MENU_ID = 'M00008-03')
BEGIN
	INSERT INTO [dbo].[TB_M_AUTH_MENU] (ROLE_ID, MENU_ID, CREATED_BY, CREATED_DT)
	VALUES ('DMS-ADMIN', 'M00008-03', 'dms.admin', GETDATE());
END
