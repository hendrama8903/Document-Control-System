...
BEGIN
    ...
    SELECT
        ...
        S.COMPANY_CODE,
        S.SECTION_CODE,
        ISNULL(S.SECTION_NAME, SEC.SECTION_NAME) AS SECTION_NAME,
        ...
        NULL AS CURRENT_APPROVAL_SEQ,
        NULL AS TOTAL_APPROVAL_SEQ,
        NULL AS CURRENT_APPROVAL_LABEL,
        NULL AS CURRENT_APPROVER,
        NULL AS CURRENT_APPROVER_NAME
