...
BEGIN TRY
	...
	INSERT INTO [dbo].[TB_R_DOC_SUBMISSION_FORM_H] (
		SUBMISSION_NO, DIVISION, DIVISION_NAME, DEPARTMENT_ID, DEPARTMENT_CODE, DEPARTMENT_NAME, SECTION_CODE, SECTION_NAME, SUBMISSION_DATE, DOC_CATEGORY,
		REMARK, STATUS, DOCUMENT_CREATOR, DELETE_FLAG, CREATED_BY, CREATED_DT, CHANGED_BY, CHANGED_DT
	) VALUES (
		@SubmissionNo, @DIVISION, @snap_DIVISION_NAME, @DEPARTMENT_ID, @snap_DEPARTMENT_CODE, @snap_DEPARTMENT_NAME, @SECTION_CODE, @snap_SECTION_NAME, @SUBMISSION_DATE, @DOC_CATEGORY,
