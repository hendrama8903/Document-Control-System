...
-- 										UDSYS.SYSTEM_VALUE AS CREATOR_DIVISION_NAME,
									...
									LEFT JOIN TB_R_DOCUMENT_FOLDER_PERSONAL UDF
										ON UDF.DOCUMENT_TRANSACTION_ID = S.DOCUMENT_TRANSACTION_ID
											AND UDF.USERNAME = ''' + @LOGIN_USER + '''
									LEFT JOIN TB_M_DOCUMENT_FOLDER_PERSONAL FOLD
										ON FOLD.FOLDER_ID = UDF.FOLDER_ID
