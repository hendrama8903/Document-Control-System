...
-- awal, untuk mulai testing/UAT dari kondisi bersih (2026-08-19).
--
-- Versi lanjutan dari Maintenance_ResetTransactionData_20260818.sql -
-- daftar tabel TB_R_* dicek ulang terhadap INFORMATION_SCHEMA.TABLES,
-- tidak ada tabel transaksi baru sejak 08-18 jadi cakupannya sama persis.
--
-- Backup diambil dulu (SELECT INTO ..._BACKUP_20260819) sebelum
-- TRUNCATE/DELETE, supaya masih bisa dipulihkan kalau ternyata perlu.
-- Tabel _BACKUP_* lama (20260810, 20260816, 20260818, dst) TIDAK disentuh.
--
...
-- Bagian 1: Backup
-- ---------------------------------------------------------------------
SELECT * INTO TB_R_DOCUMENT_BACKUP_20260819 FROM TB_R_DOCUMENT;
SELECT * INTO TB_R_CTRL_DOCUMENT_BACKUP_20260819 FROM TB_R_CTRL_DOCUMENT;
SELECT * INTO TB_R_DOCUMENT_DISTRIBUTION_BACKUP_20260819 FROM TB_R_DOCUMENT_DISTRIBUTION;
SELECT * INTO TB_R_DOCUMENT_LOG_BACKUP_20260819 FROM TB_R_DOCUMENT_LOG;
SELECT * INTO TB_R_DOCUMENT_HISTORY_BACKUP_20260819 FROM TB_R_DOCUMENT_HISTORY;
SELECT * INTO TB_R_PUBLISH_HISTORY_BACKUP_20260819 FROM TB_R_PUBLISH_HISTORY;
SELECT * INTO TB_R_APPROVAL_H_BACKUP_20260819 FROM TB_R_APPROVAL_H;
SELECT * INTO TB_R_APPROVAL_D_BACKUP_20260819 FROM TB_R_APPROVAL_D;
SELECT * INTO TB_R_APPROVAL_REASSIGN_LOG_BACKUP_20260819 FROM TB_R_APPROVAL_REASSIGN_LOG;
SELECT * INTO TB_R_DOC_SUBMISSION_FORM_H_BACKUP_20260819 FROM TB_R_DOC_SUBMISSION_FORM_H;
SELECT * INTO TB_R_DOC_SUBMISSION_FORM_D_BACKUP_20260819 FROM TB_R_DOC_SUBMISSION_FORM_D;
SELECT * INTO TB_R_COPY_REQUEST_H_BACKUP_20260819 FROM TB_R_COPY_REQUEST_H;
SELECT * INTO TB_R_COPY_REQUEST_D_BACKUP_20260819 FROM TB_R_COPY_REQUEST_D;
SELECT * INTO TB_R_COPY_REQUEST_PRINT_LOG_BACKUP_20260819 FROM TB_R_COPY_REQUEST_PRINT_LOG;
SELECT * INTO TB_R_NOTIFICATION_BACKUP_20260819 FROM TB_R_NOTIFICATION;
SELECT * INTO TB_R_LOG_H_BACKUP_20260819 FROM TB_R_LOG_H;
SELECT * INTO TB_R_LOG_D_BACKUP_20260819 FROM TB_R_LOG_D;
SELECT * INTO TB_M_EXTERNAL_DOCUMENT_BACKUP_20260819 FROM TB_M_EXTERNAL_DOCUMENT;
GO
