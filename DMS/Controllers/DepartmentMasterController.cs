...
namespace DMS.Controllers
{
    public class DepartmentMasterController : BaseController
    {
        ...
        public ActionResult Search(DepartmentMaster data, bool initialMode)
        {
            try
            {
                ...
                {
                    var listData = departmentMasterRepo.Search(data, db, pageNumber, pageSize);
                    var dataCount = departmentMasterRepo.Search(data, db, null, null).Count;
